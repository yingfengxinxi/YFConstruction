    ...
    handleRowClick(row, column, event) {
      ...
      if (this.crmType === 'leads') {
        ...
        if (column.property === 'expenseNum') {
          //考虑是否报销
          //console.log(row.hasExamine)
          if(row.hasExamine == "0"){
            this.rowType = 'expense'
            this.rowID = row.expenseId
          }else{//expense-examines
            this.rowType = 'expense-examines'
    ...
    exportInfos() {
      ...
      if (this.isSeas) {
        ...
        request = {
          ...
          expense: crmExpenseExcelAllExportAPI,
        }[this.crmType]
      }
