...
import RelativeProject from '../components/RelativeProject' // 项目
...
export default {
  ...
  computed: {
    ...
    tabNames() {
      ...
      // console.log("tabNames==this.crm==="+JSON.stringify(this.crm))
      var tempsTabs = []
      ...
      // if (this.project.projectManage && this.project.projectManage.detail) {
      //   tempsTabs.push({ label: this.getTabName('项目', this.tabsNumber.projectCount), name: 'RelativeProject' })
      // }
