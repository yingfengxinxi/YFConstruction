...
import {
  crmBusinessQueryVisitAPI
} from '@/api/crm/business'
import {
  crmContactsQueryVisitAPI
  ...
  methods: {
    ...
    getDetail(loading = true) {
      ...
      const request = {
        ...
        business: crmBusinessQueryVisitAPI,
        contacts: crmContactsQueryVisitAPI
      }[this.crmType]
    ...
    createClick() {
      ...
      if (this.crmType == 'customer') {
        ...
        this.createActionInfo.relativeData = {
          businessId: this.detail.buseinessId
        }
      } else if (this.crmType == 'contacts') {
        this.createActionInfo.data['customer'] = this.detail
        this.createActionInfo.data['contacts'] = this.detail
        this.createActionInfo.relativeData = {
