...
import ExpenseCreate from '@/views/crm/expense/Create'
import ExpenseExamineCreate from '@/views/crm/expense/Examine'
export default {
  name: 'CRMAllCreate',
  //TODO 详情之上编辑扩展
  components: {
  ...
  computed: {
    componentName() {
      return {
        ...
        'expense-examines':'ExpenseExamineCreate'
      }[this.crmType]
    }
  },
  watch: {
