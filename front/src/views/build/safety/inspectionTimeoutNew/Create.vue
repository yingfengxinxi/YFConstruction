    ...
    @save="debouncedSaveField(true)">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="隐患编号" prop="hiddenNum">
              <el-input v-model="form.hiddenNum" :disabled="true" placeholder="请输入"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="隐患类别" prop="category">
              <el-select v-model="form.category" :disabled="!(action.type == 'save') && !(action.type == 'update')" 
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="隐患等级" prop="level">
              <el-select v-model="form.level" :disabled="!(action.type == 'save') && !(action.type == 'update')" 
			  @change="levelChange" placeholder="请选择计划类型">
                <el-option
		  ...
		  <el-col :span="12">
		    <el-form-item label="风险点类型" prop="riskType">
		      <el-select v-model="form.riskType" :disabled="!(action.type == 'save') && !(action.type == 'update')" 
			  @change="riskTypeChange" placeholder="请选择风险点类型">
		        <el-option
		          v-for="item in riskPointOption"
		          :key="item.value"
		          :label="item.label"
		          :value="item.value">
		        </el-option>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="风险点名称" prop="riskName">
			  <el-input v-model="form.riskName" :disabled="!(action.type == 'save') && !(action.type == 'update')" 
			  readonly v-on:click.native="inputClick"
			  ></el-input>
            </el-form-item>
          </el-col>
		  <el-col :span="12">
		    <el-form-item label="事故类型" prop="accidentType">
		      <el-select v-model="form.accidentType" :disabled="!(action.type == 'save') && !(action.type == 'update')" 
			  placeholder="请选择事故类型">
		        <el-option
		          v-for="item in dictData.accidentTypeDict"
		          :key="item.dictValue"
		          :label="item.dictLabel"
		          :value="item.dictValue">
		        </el-option>
        ...
        <el-row>
		  <el-col :span="12">
		    <el-form-item label="隐患描述" prop="riskDesc">
		      <el-input v-model="form.riskDesc" :disabled="!(action.type == 'save') && !(action.type == 'update')"  
			  placeholder="请输入隐患描述"
		      ></el-input>
		    </el-form-item>
		  </el-col>
		...
		<el-row>
		  <el-col :span="24">
		    <el-form-item label="主要治理措施" prop="administerStep">
		      <el-input type="textarea" :rows="2" :disabled="!(action.type == 'save') && !(action.type == 'update')"  
			  v-model="form.administerStep"  placeholder="请输入"></el-input>
		    </el-form-item>
		  </el-col>
		</el-row>
		<!--图片上传-->
	  ...
	  <create-sections title="检查信息">
		  <el-row>
		    <el-col :span="12">
		      <el-form-item label="检查负责人" prop="checkPersonName">
		        <el-input v-model="form.checkPersonName" :disabled="true" placeholder="请输入"></el-input>
		      </el-form-item>
		    </el-col>
		    <el-col :span="12">
		      <el-form-item label="联系电话" prop="checkPersonPhone">
		        <el-input v-model="form.checkPersonPhone" :disabled="true" placeholder="请输入"></el-input>
		      </el-form-item>
		    </el-col>
		  </el-row>
		  <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="检查类型" prop="routineCheckType">
              <el-select v-model="form.routineCheckType" :disabled="!(action.type == 'save') && !(action.type == 'update')" 
			   @change="routineCheckTypeChange" placeholder="请选择检查类型">
                <el-option
                  v-for="item in dictData.routineCheckTypeDict"
                  :key="item.dictValue"
                  :label="item.dictLabel"
                  :value="item.dictValue">
                </el-option>
		  ...
		  <el-row>
		    <el-col :span="12">
		      <el-form-item label="检查区域" prop="checkArea">
		        <el-input v-model="form.checkArea" :disabled="!(action.type == 'save') && !(action.type == 'update')"  
		  ...
		  <el-row>
		    ...
		    <el-col :span="12">
		      <el-form-item label="联系电话" prop="rectifyPersonPhone">
		        <el-input v-model="form.rectifyPersonPhone" :disabled="true" placeholder="请输入"></el-input>
		      </el-form-item>
		    </el-col>
		  </el-row>
		  <el-row v-if="!(action.type == 'save') && !(action.type == 'update')">
		    <el-col :span="12">
		      <el-form-item label="实际整改人" prop="actualRectifyPersonName">
		        <el-input v-model="form.actualRectifyPersonName" :disabled="true" placeholder="请输入"></el-input>
		      </el-form-item>
		    </el-col>
		    <el-col :span="12">
		      <el-form-item label="联系电话" prop="actualRectifyPersonPhone">
		        <el-input v-model="form.actualRectifyPersonPhone" :disabled="true" placeholder="请输入"></el-input>
		      </el-form-item>
		    </el-col>
		  </el-row>
		  <el-row v-if="!(action.type == 'save') && !(action.type == 'update')">
		    <el-col :span="12">
		      <el-form-item label="整改情况" prop="dutySituation">
		        <el-input v-model="form.dutySituation" :disabled="!(action.type == 'rectify')"  placeholder="请输入"></el-input>
		      </el-form-item>
		    </el-col>
		    <el-col :span="12">
		  ...
		  <el-row>
		    <el-col :span="12">
		      <el-form-item label="复查人" prop="examinePersonName">
		        <el-input v-model="form.examinePersonName" :disabled="true" placeholder="请输入"></el-input>
		      </el-form-item>
		    </el-col>
		    <el-col :span="12">
		      <el-form-item label="联系电话" prop="examinePersonPhone">
		        <el-input v-model="form.examinePersonPhone" :disabled="true" placeholder="请输入"></el-input>
		      </el-form-item>
		    </el-col>
		  </el-row>
		  <el-row>
		    <el-col :span="12">
		      <el-form-item label="复查情况" prop="reExamineSituttion">
		        <el-input v-model="form.reExamineSituttion" :disabled="action.type == 'details'"  placeholder="请输入"></el-input>
		      </el-form-item>
		    </el-col>
		    <el-col :span="12">
	  ...
	  <el-dialog :title="title2" :visible.sync="open2" width="1000px" append-to-body>
	    ...
	    <el-table v-loading="loading" :data="dataList2" height="250px" @row-dblclick="dobuleClick">
	      <el-table-column label="风险编号" align="center" prop="riskNum" />
		  ...
		  <el-table-column label="风险等级" :formatter="riskLevelIdentFc" align="center" prop="riskType" :show-overflow-tooltip="true" />
		  <el-table-column label="潜在事故类型" :formatter="accidentTypeFc"  align="center" prop="accidentType" :show-overflow-tooltip="true" />
		  <el-table-column label="管控层级" :formatter="riskLevelOptionsFc" align="center" prop="controlLevel" :show-overflow-tooltip="true" />
...
<script>
  ...
  import {save, updateInfo, getById, getNumber, selectStaticRiskList, selectDynamicRiskList, getTeamLeaderList} from "../api/riskDetection"
  ...
  export default {
    ...
    created() {
      ...
      if (this.action.type == "save") {
		...
		this.form.rectifyTime = this.formatterDate(new Date().getTime() + 24 * 60 * 60 * 1000)
      } else {
        this.getDetail();
	  }
    },
    ...
    methods: {
	  ...
	  inputClick() {
		...
		if (this.form.riskType == '1') {
			this.title2 = '选择静态风险数据'
		} else if (this.form.riskType == '2'){
			this.title2 = '选择动态风险数据'
		} else {
