<template>
  <xr-create
    ...
    @save="debouncedSaveField(true)">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="风险点名称" prop="riskName">
			  ...
			  readonly v-on:click.native="inputClick" suffix-icon="el-icon-search" placeholder="请选择风险点"
			  ></el-input>
            </el-form-item>
          </el-col>
		  <el-col :span="12">
        ...
        <el-row>
		  ...
		  <el-col :span="12">
		    <el-form-item label="主要治理措施" prop="administerStep">
		      <el-input v-model="form.administerStep" :disabled="!(action.type == 'save') && !(action.type == 'update')"  
		  ...
		  <el-row>
			  <el-col :span="12">
				<el-form-item label="是否整改" prop="isRectify">
				  <el-select v-model="form.isRectify" :disabled="!(action.type == 'save') && !(action.type == 'update')" 
				   placeholder="请选择检查类型">
					<el-option
	  ...
	  <create-sections v-if="form.isRectify == '1'" title="整改信息">
		  <el-row>
		  <el-col :span="12">
		  ...
		  <el-row v-if="!(action.type == 'save') && !(action.type == 'update')">
		    <el-col :span="12">
		      <el-form-item label="整改情况" prop="dutySituation">
		        <el-input v-model="form.dutySituation" :disabled="!(action.type == 'rectify')"  placeholder="请输入整改情况"></el-input>
		      </el-form-item>
		    </el-col>
		    <el-col :span="12">
	  ...
	  <create-sections v-if="(action.type == 'recheck' || action.type == 'details') && form.isRectify == '1'" title="复检信息">
		  <el-row>
		    <el-col :span="12">
		    ...
		    <el-col :span="12">
		      <el-form-item label="联系电话" prop="examinePersonPhone">
		        <el-input v-model="form.examinePersonPhone" :disabled="true" placeholder="请输入联系电话"></el-input>
		      </el-form-item>
		    </el-col>
		  </el-row>
		  <el-row>
		    <el-col :span="12">
		      <el-form-item label="复查情况" prop="reExamineSituttion">
		        <el-input v-model="form.reExamineSituttion" :disabled="action.type == 'details'"  placeholder="请输入复查情况"></el-input>
		      </el-form-item>
		    </el-col>
		    <el-col :span="12">
	  ...
	  <el-dialog :title="title2" :visible.sync="open2" width="1000px" append-to-body>
	    ...
	    <el-table v-loading="loading" :data="dataList2" height="450px" @row-dblclick="dobuleClick">
		  ...
		  <el-table-column label="风险等级" :formatter="riskLevelIdentFc" align="center" prop="riskType" width="80px" :show-overflow-tooltip="true" />
		  <el-table-column label="潜在事故类型" :formatter="accidentTypeFc"  align="center" prop="accidentType"  width="100px" :show-overflow-tooltip="true" />
		  <el-table-column label="管控层级" :formatter="riskLevelOptionsFc" align="center" prop="controlLevel" width="80px" :show-overflow-tooltip="true" />
