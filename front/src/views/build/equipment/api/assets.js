 ...
 * @param {*} data
 */
export function querySalesOfficeProjectList(data) {
  return request({
 ...
 * @param data
 */
export function getTowerConfig(data) {
  return request({
    url: 'build/equipmentTowerCrane/getByDeviceId/'+data,
    method: 'post',
  })
}

export function savTowerConfig(data) {
  return request({
    url: 'build/equipmentTowerCrane/save',
    method: 'post',
    data: data,
    headers: {
      'Content-Type': 'application/json;charset=UTF-8'
