<template>
  <div class="dom">
    ...
    <div class="dom_2">
      <div class="dom_2_t">
        <div class="subject"><img   :onerror='`this.src="${require("@/assets/noimgsrc.png")}"`'    src="../../../../../static/img/Symbol.png">今日高支模工作情况</div>
        <div class="gzxq_dom">
          <div class="gzxq_doms" >
...
<script>
  ...
  import { getList,getGzmAlertList,getGzmList} from './api/pit'
