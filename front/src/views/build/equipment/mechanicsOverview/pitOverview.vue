  ...
  <div class="dom">
    <div class="dom_1">
      ...
      <img   :onerror='`this.src="${require("@/assets/noimgsrc.png")}"`'
        ...
        @click="goStateList(item.id)"
        src="../../../../../static/img/towerCraneMonitor/sjk_icon.png"/>
    </div>
    <div class="dom_2">
      <div class="dom_2_t">
        <div class="subject"><img   :onerror='`this.src="${require("@/assets/noimgsrc.png")}"`'    src="../../../../../static/img/Symbol.png">今日深基坑工作情况</div>
        <div class="gzxq_dom">
          <div class="gzxq_doms" >
      ...
      <div class="dom_2_b">
        ...
        <div class="table_dom">
          <table cellpadding="0" cellspacing="0" class="my_table">
            <tr v-for="item in list.slice(0,8)">
              ...
              <td width="35px"><img   :onerror='`this.src="${require("@/assets/noimgsrc.png")}"`'    v-if="item.line==1" height="20px" src='../../../../../static/img/towerCraneMonitor/yxico.png'>
              	<img   :onerror='`this.src="${require("@/assets/noimgsrc.png")}"`'    height="20px" v-else src='../../../../../static/img/towerCraneMonitor/lxico.png'/></td>
...
<script>
  ...
  import { getList,getJkAlertList,getJkList} from './api/pit'
      ...
      methods: {
        ...
        goToUrl (path, queryParams) {
          ...
          queryMenuListByPath(param).then(res => {
            ...
            this.$router.push({ name: activeclass.name, params: queryParams })
          })
        },
      }
    }
