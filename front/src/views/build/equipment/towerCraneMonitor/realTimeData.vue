<template>
  <div class="main_div">
    <div class="spaceSon" style="margin-top: 0.34rem;">
      ...
      <div class="numbers">{{lzData.length<=0?0:lzData[0].fd}}m</div>
      <div class="prop1">
    ...
    <div class="spaceSon" style="margin-top: 0.34rem;">
      ...
      <div class="numbers">{{lzData.length<=0?0:lzData[0].gd}}m</div>
      <div class="prop2">
    ...
    <div class="spaceSon" style="margin-top: 0.34rem;">
      ...
      <div class="numbers">{{lzData.length<=0?0:lzData[0].zj}}m</div>
      <div class="prop3">
    ...
    <div class="spaceSon">
      ...
      <div class="numbers">{{lzData.length<=0?0:lzData[0].dz}}T</div>
      <div class="prop4">
    ...
    <div class="spaceSon">
      ...
      <div class="numbers">{{lzData.length<=0?0:lzData[0].lj}}N·m</div>
      <div class="prop5">
    ...
    <div class="spaceSon">
      ...
      <div class="numbers">{{lzData.length<=0?0:lzData[0].fs}}m/s</div>
      <div class="prop6">
    ...
    <div class="spaceSon">
      ...
      <div class="numbers">{{lzData.length<=0?0:lzData[0].qjx}}m</div>
      <div class="prop7">
    ...
    <div class="spaceSon">
      ...
      <div class="numbers">{{lzData.length<=0?0:lzData[0].qjy}}m</div>
      <div class="prop8">
