		...
		<el-row>
		  <el-col :span="8">
			<el-form-item label="单据编号" prop="qualDocumentNumber">
			  <el-input v-model="checkForm.qualDocumentNumber" placeholder="请输入单据编号"></el-input>
			</el-form-item>
		  </el-col>
		  <el-col :span="8">
...
<script>
  ...
  import {generateDocumentNumber, saveOrUpdate, getById, receiptInfo} from "../qual/api/check";
