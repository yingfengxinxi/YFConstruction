        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="200px">
          <template slot-scope="scope">
            <el-button
              ...
              type="text"
              icon="el-icon-edit"
              @click="receiptClick(scope.row.checkId)"
            >复检
            </el-button>
          </template>
        </el-table-column>
...
<script>
  ...
  import Create from '@/views/build/qual/check/Create'
  import Detail from '@/views/build/qual/check/Detail'

  /* import {getList, delTrueByIds} from "../api/plan"; */
  import {getQualCheckList, delTrueByIds} from "@/views/build/qual/api/check"
  ...
  export default {
    ...
    methods: {
	   ...
	   */
	  receiptClick(id) {
		  this.action.type = 'receipt'
		  this.action.isReadonly = true
		  this.action.id = id
		  this.createShow = true
	  },
      /**
