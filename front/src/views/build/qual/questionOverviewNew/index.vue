		...
		<el-row>
		    <el-col :span="12">
				<el-card class="box-card" style="margin: 10px">
					<div ref="firstMain" class="title">日常质量检查问题发生Top10</div>
...
import {selectPieData, selectBarData, selectWarningData} from '../api/questionOverviewNew'

export default{
    name: 'questionOverviewNew',
    components: {
