			...
			<el-row>
				...
				<el-col :span="12">
					<el-form-item label="自评月份" prop="evaluateMonth">
						<el-date-picker v-model="form.evaluateMonth" value-format="yyyy" type="year" placeholder="选择年">
						</el-date-picker>
					</el-form-item>
				</el-col>
			</el-row>
			<el-row>
				<el-col :span="24">
					<el-table :data="tableData" border
						...
						<el-table-column label="评定项目" prop="securityEvaluationName"></el-table-column>
						<el-table-column label="评分标准" width="200px" prop="securityEvaluationStandard" ></el-table-column>
						<el-table-column label="评定方法" width="200px"  prop="securityEvaluationFunction"></el-table-column>
						<el-table-column prop="shouldScore" label="应得分数"></el-table-column>
