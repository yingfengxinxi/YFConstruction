...
<script>
  ...
  import {saveOrUpdate, getById, selectFBSInfo, selectInfoByMapNoPage} from "./subpeo";
    ...
    methods: {
      ...
      getDetail() {
        getById(this.action.id)
          .then(res => {
            //根据分包商查询人员列表信息
            this.selectInfoByMapNoPage(res.data.subcontractor)
