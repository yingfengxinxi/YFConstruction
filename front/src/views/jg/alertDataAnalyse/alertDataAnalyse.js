 ...
 * @param {*} data
 */
export function selectAlertList() {
  return request({
    url: 'build/monitorPointAlert/selectAlertList',
    method: 'post',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8'
    }
 ...
 * @param {*} data
 */
export function selectTypeProportion() {
  return request({
    url: 'build/monitorPointAlert/selectTypeProportion',
    method: 'post',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8'
    }
