...
export function getList(data) {
  return request({
    url: 'build/labourSpeworktype/selectTabsByInfoNew',
    method: 'post',
    data: data,
    headers: {
...
export function saveOrUpdate(data) {
  return request({
    url: 'build/labourSpeworktype/saveOrUpdate',
    method: 'post',
    data: data,
    headers: {
      'Content-Type': 'application/json;charset=UTF-8'
...
export function getById(data) {
  return request({
    url: 'build/labourSpeworktype/queryById/'+data,
    method: 'post',
    data: data,
    headers: {
      'Content-Type': 'application/json;charset=UTF-8'
...
export function  delTrueByIds(data) {
  return request({
    url: 'build/labourSpeworktype/delTrueByIds',
    method: 'post',
    data: data,
    headers: {
      'Content-Type': 'application/json;charset=UTF-8'
