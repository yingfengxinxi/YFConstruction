	...
	<div id="cloudCenter">
		<div class="left_box">
			<div class="left-top">
				...
				<div class="left-top-center">
					<div class="workers_box" @click="gotoRoster()">
						...
						<div class="flex-center workers_num">
							<span class="num-back">0</span>
							<span class="num-back">4</span>
							<span class="num-back">2</span>
							<span class="num-back">6</span>
						</div>
					...
					<div class="workers_box" @click="gotoRoster()">
						...
						<div class="flex-center workers_num">
							<span class="num-back">0</span>
							<span class="num-back">5</span>
							<span class="num-back">3</span>
							<span class="num-back">4</span>
						</div>
						<span class="workers_untils">人</span>
					</div>
				...
				<div class="left-top-bottom">
					<div class="left-top-bottom-item" @click="gotoAttendanceDetail()()">
						<div class="left-item-title"><span>管理人员</span> <p class="left-item-value">64</p></div>
					</div>
					<div class=" unback" @click="gotoAttendanceDetail()">
						<div class="people_gl">
							...
							<span>出勤率</span>
							<p class="left-item-value">95%</p>
						</div>
					</div>
					<div class="left-top-bottom-item" @click="gotoAttendanceDetail()">
						<div class="left-item-title"><span>普通工人</span> <p class="left-item-value">362</p></div>
					</div>
					<div class=" unback" @click="gotoAttendanceDetail()">
						<div class="people_gl">
							<img   :onerror='`this.src="${require("@/assets/noimgsrc.png")}"`'    src="../../../../assets/people/cql.png" style="width: .2rem;height: .2rem;">
							<span>出勤率</span>
							<p class="left-item-value">88%</p>
						</div>
					</div>
				</div>
			</div>
            ...
            <div class="dynamic-info">
              <img   :onerror='`this.src="${require("@/assets/noimgsrc.png")}"`'    src="../../../../assets/people/avatar.png" alt="" class="dynamic-avatar">
              <div class="dynamic-user-info">
                <span class="text-12 text-404040">姓名 {{ item.name }}</span>
                <span class="text-12 text-404040" style="margin: .06rem 0">项目 {{ item.projectName }}</span>
                <span class="text-12 text-070707 text-600">{{ item.post }}</span>
              </div>
            </div>

            <div class="flex-center">
              <div class="spot bg-ff6100" style="margin-right: .1rem"></div>
              <span class="text-14 text-404040 text-400" style="margin-top: .08rem">{{ item.time }}</span>
            </div>
          </div> -->
					<div class="dynamic-item">
						<div class="dynamic-info">
							<img   :onerror='`this.src="${require("@/assets/noimgsrc.png")}"`'    src="../../../../assets/people/p1.png" alt="" class="dynamic-avatar">
							<div class="dynamic-user-info">
								<span class="text-12 text-404040">姓名 柳传志</span>
								<span class="text-12 text-404040">地鑫新河花园项目</span>
								<span class="text-12 text-070707 text-600">质量员</span>
							</div>
						</div>

						<div class="flex-center dynamic_time">
							<div class="spot bg-ff6100" style="margin-right: .1rem"></div>
							<span class="text-14 text-404040 text-400">2021-11-29 08:22:20</span>
						</div>
					</div>
					<div class="dynamic-item">
						<div class="dynamic-info">
							<img   :onerror='`this.src="${require("@/assets/noimgsrc.png")}"`'    src="../../../../assets/people/p2.png" alt="" class="dynamic-avatar">
							<div class="dynamic-user-info">
								<span class="text-12 text-404040">姓名 钱兴天</span>
								<span class="text-12 text-404040">幸福小区项目</span>
								<span class="text-12 text-070707 text-600">工程经理</span>
							</div>
						</div>

						<div class="flex-center dynamic_time">
							<div class="spot bg-ff6100" style="margin-right: .1rem"></div>
							<span class="text-14 text-404040 text-400">2021-11-29 07:39:51</span>
						</div>
					</div>
					<div class="dynamic-item">
						<div class="dynamic-info">
							<img   :onerror='`this.src="${require("@/assets/noimgsrc.png")}"`'    src="../../../../assets/people/p3.png" alt="" class="dynamic-avatar">
							<div class="dynamic-user-info">
								<span class="text-12 text-404040">姓名 周明超</span>
								<span class="text-12 text-404040">德百玫瑰公馆A区项目</span>
								<span class="text-12 text-070707 text-600">项目经理</span>
							</div>
						</div>

						<div class="flex-center dynamic_time">
							<div class="spot bg-ff6100" style="margin-right: .1rem"></div>
							<span class="text-14 text-404040 text-400">2021-11-29 07:21:33</span>
						</div>
					</div>
					<div class="dynamic-item">
						<div class="dynamic-info">
							<img   :onerror='`this.src="${require("@/assets/noimgsrc.png")}"`'    src="../../../../assets/people/p4.png" alt="" class="dynamic-avatar">
							<div class="dynamic-user-info">
								<span class="text-12 text-404040">姓名 张森林</span>
								<span class="text-12 text-404040">富力城项目二期</span>
								<span class="text-12 text-070707 text-600">项目总工程师</span>
							</div>
						</div>

						<div class="flex-center dynamic_time">
							<div class="spot bg-ff6100" style="margin-right: .1rem"></div>
							<span class="text-14 text-404040 text-400">2021-11-25 15:24:12</span>
						</div>
					</div>
					<div class="dynamic-item">
						<div class="dynamic-info">
							<img   :onerror='`this.src="${require("@/assets/noimgsrc.png")}"`'    src="../../../../assets/people/p5.png" alt="" class="dynamic-avatar">
							<div class="dynamic-user-info">
								<span class="text-12 text-404040">姓名 王先奇</span>
								<span class="text-12 text-404040">丰润花园项目</span>
								<span class="text-12 text-070707 text-600">项目总工程师</span>
							</div>
						</div>
						...
						<div class="flex-center dynamic_time">
							<div class="spot bg-ff6100" style="margin-right: .1rem"></div>
							<span class="text-14 text-404040 text-400">2021-11-29 08:11:10</span>
						</div>
					</div>
					<div class="dynamic-item">
						<div class="dynamic-info">
							<img   :onerror='`this.src="${require("@/assets/noimgsrc.png")}"`'    src="../../../../assets/people/p6.png" alt="" class="dynamic-avatar">
							<div class="dynamic-user-info">
								<span class="text-12 text-404040">姓名 刘浩</span>
								<span class="text-12 text-404040">丰润花园项目</span>
								<span class="text-12 text-070707 text-600">施工员</span>
							</div>
						</div>

						<div class="flex-center dynamic_time">
							<div class="spot bg-ff6100 " style="margin-right: .1rem"></div>
							<span class="text-14 text-404040 text-400">2021-11-23 19:31:20</span>
						</div>
					</div>
					<div class="dynamic-item">
						<div class="dynamic-info">
							<img   :onerror='`this.src="${require("@/assets/noimgsrc.png")}"`'    src="../../../../assets/people/p7.png" alt="" class="dynamic-avatar">
							<div class="dynamic-user-info">
								<span class="text-12 text-404040">姓名 张思源</span>
								<span class="text-12 text-404040">丰润花园项目</span>
								<span class="text-12 text-070707 text-600">材料员</span>
							</div>
						</div>

						<div class="flex-center dynamic_time">
							<div class="spot bg-ff6100" style="margin-right: .1rem"></div>
							<span class="text-14 text-404040 text-400">2021-11-29 08:44:50</span>
						</div>
					</div>
					<div class="dynamic-item">
						<div class="dynamic-info">
							<img   :onerror='`this.src="${require("@/assets/noimgsrc.png")}"`'    src="../../../../assets/people/p8.png" alt="" class="dynamic-avatar">
							<div class="dynamic-user-info">
								<span class="text-12 text-404040">姓名 王德伟</span>
								<span class="text-12 text-404040">幸福小区项目</span>
								<span class="text-12 text-070707 text-600">质量员</span>
							</div>
						</div>
						...
						<div class="flex-center dynamic_time">
							<div class="spot bg-ff6100 " style="margin-right: .1rem"></div>
							<span class="text-14 text-404040 text-400">2021-11-29 08:58:02</span>
						</div>
					</div>
					...
					<div class="center-top-data">
						<div class="center-top-left" @click="gotoRoster()">
							<div class="flex-center">
								...
								<span class="text-16 text-400 text-070707 flex-center his_peo_box">历史施工人数 <span class="his_peo_num">5672</span>人</span>
							</div>
						</div>
						<div class="center-top-left">
							<div class="sex_zb">
								...
								<div class="flex-center flex-column alitem-start sex_box">
									...
									<div class="sex_than">
										<span class="data-info">同比 10%</span>
										<span class="data-info">环比 3%</span>
									</div>
								</div>
							</div>
						</div>
						<div class="center-top-left">
							<div class="sex_zb">
								...
								<div class="flex-center flex-column alitem-start sex_box">
									...
									<div class="sex_than">
										<span class="data-info">同比 9.2%</span>
										<span class="data-info">环比 1.3%</span>
									</div>
								</div>
							</div>
						</div>
...
<script>
	...
	export default {
		data() {
			return {
				datetime: null,
				dynamicList: [ // 这是左侧下方的动态数据
					{
						name: '杨树林',
						time: '2021-11-28 10:26:58',
						projectName: '中铁十八局一期',
						post: '项目总监',
						avatar: '../../../../assets/people/avatar.png'
					},
					{
						name: '杨树林',
						time: '2021-11-28 10:26:58',
		...
		methods: {
			...
			jzgrgz() {
				var option = {
					...
					series: [{
							...
							data: [2020, 2182, 1391, 2410, 2030, 2970]
						},
						{
							name: '实发工资',
							type: 'line',
							...
							data: [2020, 2052, 1290, 2210, 1630, 1470]
						}
					]
				};
			...
			// 拖欠工资
			tqgzqy() {
				let yLabel = ['山东格瑞德集团', '永信建设有限公司', '百川汇建筑劳务有限公司', '菏泽杰成建筑有限公司',
					'青岛正中建筑劳务有限公司 ', '羿盛建筑劳务有限公司', '正大同劳务有限公司', '怀德金辉有限公司'
				]
				let yData = [87, 66, 52, 43, 41, 33, 33, 20]
				let bgData = []
				for(let i in yData) {
					bgData.push(100)
				}
