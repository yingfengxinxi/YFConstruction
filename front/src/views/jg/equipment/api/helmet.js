...
export function getList(data) {
  return request({
    url: 'build/equipmentHelmet/selectProList',
    method: 'post',
    data: data,
    headers: {
...
export function selectActionTrack(data) {
  return request({
    url: 'build/equipmentHelmetGps/selectActionTrack',
    method: 'post',
    data: data,
    headers: {
      'Content-Type': 'application/json;charset=UTF-8'
...
export function getSVG(data) {
  return request({
    url: 'build/equipmentHelmet/getSvg',
    method: 'get',
    headers: {
      'Content-Type': 'application/json;charset=UTF-8'
    }
