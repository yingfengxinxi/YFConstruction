...
public class AdminMessageServiceImpl extends BaseServiceImpl<AdminMessageMapper, AdminMessage> implements IAdminMessageService {
    ...
    @Override
    public AdminMessageVO queryUnreadNoticeCount() {
        return getBaseMapper().queryUnreadNoticeCount(UserUtil.getUserId());
    }
    ...
    public void addMessage(AdminMessageBO adminMessageBO) {
        ...
        switch (messageEnum) {
            ...
            case CRM_EXPENSE_PASS:
            case CRM_EXPENSE_REJECT:
     ...
     * @author zhangzhiwei
     */
    private void addOaTaskMessage(AdminMessageEnum messageEnum, String name, Object typeId, Long userId, List<Long> ids) {
     ...
     * @author zhangzhiwei
     */
    private void addOaLogSendMessage(AdminMessageEnum messageEnum, Object typeId, Long userId, List<Long> ids) {
        List<AdminMessage> messageList = new ArrayList<>();
        ids.forEach(id -> {
            AdminMessage adminMessage = new AdminMessage();
            adminMessage.setCreateTime(new Date());
     ...
     * @author zhangzhiwei
     */
    private void addOaLogReplyMessage(AdminMessageEnum messageEnum, String title, String content, Object typeId, Long userId, List<Long> ids) {
        AdminMessage adminMessage = new AdminMessage();
        adminMessage.setCreateTime(new Date());
        adminMessage.setCreateUser(userId);
        adminMessage.setType(messageEnum.getType());
    ...
    private void addKmDocumentShareNotice(AdminMessageEnum messageEnum, String title, Object typeId, Long userId, List<Long> ids) {
     ...
     * @author wyq
     */
    private void addOaExamineNotice(AdminMessageEnum messageEnum, String title, Object typeId, Long userId, List<Long> ids) {
        AdminMessage adminMessage = new AdminMessage();
        adminMessage.setCreateTime(new Date());
        adminMessage.setCreateUser(userId);
        adminMessage.setType(messageEnum.getType());
     ...
     * @author zhangzhiwei
     */
    private void addOaNoticeMessage(AdminMessageEnum messageEnum, String title, Object typeId, Long userId, List<Long> ids) {
        List<AdminMessage> messageList = new ArrayList<>();
        ids.forEach(id -> {
            AdminMessage adminMessage = new AdminMessage();
            adminMessage.setCreateTime(new Date());
     ...
     * @author zhangzhiwei
     */
    private void addOaEventMessage(AdminMessageEnum messageEnum, String title, Object typeId, Long userId, List<Long> ids) {
        List<AdminMessage> messageList = new ArrayList<>();
        ids.forEach(id -> {
            AdminMessage adminMessage = new AdminMessage();
            adminMessage.setCreateTime(new Date());
     ...
     * @author zhangzhiwei
     */
    private void addCrmExamineMessage(AdminMessageEnum messageEnum, String content, String title, Object typeId, Long userId, List<Long> ids) {
        AdminMessage adminMessage = new AdminMessage();
        adminMessage.setCreateTime(new Date());
        adminMessage.setCreateUser(userId);
        adminMessage.setType(messageEnum.getType());
    ...
    private void addCrmExamineNotice(AdminMessageEnum messageEnum, String title, Object typeId, Long userId, List<Long> ids) {
        AdminMessage adminMessage = new AdminMessage();
        adminMessage.setCreateTime(new Date());
        adminMessage.setCreateUser(userId);
        adminMessage.setType(messageEnum.getType());
     ...
     * 团队成员提醒
     */
    private void addCrmTeamMessage(AdminMessageEnum messageEnum, Object typeId, String title, Long userId) {
        AdminMessage adminMessage = new AdminMessage();
        adminMessage.setCreateTime(new Date());
     ...
     * 添加JXC审批消息
     */
    private void addJXCExamineMessage(AdminMessageEnum messageEnum, String content, String title, Object typeId, Long userId, List<Long> ids) {
        AdminMessage adminMessage = new AdminMessage();
        adminMessage.setCreateTime(new Date());
        adminMessage.setCreateUser(userId);
        adminMessage.setType(messageEnum.getType());
    ...
    private void addJXCExamineNotice(AdminMessageEnum messageEnum, String title, Object typeId, Long userId, List<Long> ids) {
        AdminMessage adminMessage = new AdminMessage();
        adminMessage.setCreateTime(new Date());
        adminMessage.setCreateUser(userId);
        adminMessage.setType(messageEnum.getType());
