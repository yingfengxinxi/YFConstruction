...
public interface AdminRoleMapper extends BaseMapper<AdminRole> {
    ...
    public List<Integer> getRoleMenuByPId(@Param("parentId") Integer parentId, @Param("roleId") Integer roleId);
    public List<Integer> getRoleMenuByMenuId(@Param("menuId") Integer menuId, @Param("roleId") Integer roleId);
    ...
    public List<Integer> queryDataTypeByRealm(@Param("userId") Long userId, @Param("realm") String realm);
