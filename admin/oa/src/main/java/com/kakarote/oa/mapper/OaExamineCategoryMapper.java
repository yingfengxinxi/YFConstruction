...
public interface OaExamineCategoryMapper extends BaseMapper<OaExamineCategory> {
    ...
    OaExamineCategory selectExamineCategoryByType(@Param("isAdmin") boolean isAdmin,@Param("userId") Long userId,
                                                  @Param("deptId") Integer deptId, @Param("type") Integer type);
}
