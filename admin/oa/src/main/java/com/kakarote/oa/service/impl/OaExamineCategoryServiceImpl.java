...
public class OaExamineCategoryServiceImpl extends BaseServiceImpl<OaExamineCategoryMapper, OaExamineCategory> implements IOaExamineCategoryService {
    ...
    @Override
    public OaExamineCategory selectExamineCategoryByType(Integer type) {
        UserInfo user = UserUtil.getUser();
        return examineCategoryMapper.selectExamineCategoryByType(UserUtil.isAdmin(),user.getUserId(),user.getDeptId(), type);
    }
