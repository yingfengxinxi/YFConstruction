...
public interface OaExamineLogMapper extends BaseMapper<OaExamineLog> {
    ...
    JSONObject queryExamineUserIdExamineId(@Param("tenantId") Long tenantId, @Param("examineId") Long examineId);

    List<JSONObject> queryExamineUserIdListExamineId(@Param("tenantId") Long tenantId, @Param("examineId") Long examineId);
