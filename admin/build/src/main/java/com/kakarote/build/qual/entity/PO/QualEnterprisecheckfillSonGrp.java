...
@TableName("b_qual_enterprisecheckfill_son_grp")
@ApiModel(value="QualEnterprisecheckfillSonGrp对象", description="施工质量--企业质量检查填报--子表")
public class QualEnterprisecheckfillSonGrp implements Serializable {
