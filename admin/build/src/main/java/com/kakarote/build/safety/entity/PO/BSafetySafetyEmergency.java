...
@TableName("b_safety_safety_emergency")
@ApiModel(value="BSafetySafetyEmergency对象", description="安全应急管理")
public class BSafetySafetyEmergency implements Serializable {
