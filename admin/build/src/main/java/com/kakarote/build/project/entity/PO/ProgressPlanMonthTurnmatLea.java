...
@TableName("b_progress_plan_month_turnmat_lea")
@ApiModel(value="ProgressPlanMonthTurnmatLea对象", description="计划管理--月计划--周转材租赁明细")
public class ProgressPlanMonthTurnmatLea implements Serializable {
