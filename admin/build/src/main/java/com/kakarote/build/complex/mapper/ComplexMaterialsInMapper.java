 ...
 * @since 2021-06-16
 */
public interface ComplexMaterialsInMapper extends BaseMapper<ComplexMaterialsIn> {

    BasePage<Map<String,Object>> selectList(BasePage<ComplexMaterialsIn> page, @Param("data") ComplexMaterialsInBO complexMaterialsInBO);
