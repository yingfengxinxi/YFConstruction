...
import com.kakarote.build.equipment.mapper.EquipmentPitDataAtBakMapper;
...
//                    getBaseMapper().insert(equipmentFormworkDataAt);
    ...
    @Override
    public BasePage<Map<String, Object>> selectPage(EquipmentPitDataAtBakBO pitDataAtBakBO) {
        pitDataAtBakBO.setOrdersBd("a.monitor_time",false);
        return getBaseMapper().selectPage(pitDataAtBakBO.parse(),pitDataAtBakBO);
    }
}
