...
@TableName("b_labour_attendance_configuration")
@ApiModel(value="BLabourAttendanceConfiguration对象", description="考勤日期设定")
public class BLabourAttendanceConfiguration implements Serializable {
