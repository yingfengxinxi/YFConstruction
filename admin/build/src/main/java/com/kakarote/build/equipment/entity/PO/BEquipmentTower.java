...
@ApiModel(value="BEquipmentTower对象", description="塔机配置表")
public class BEquipmentTower implements Serializable {
    ...
    @ApiModelProperty(value = "塔帽高0.00~655.35m")
    ...
    @ApiModelProperty(value = "力矩预警值")
    private String torqueWarningValue;

    @ApiModelProperty(value = "力矩报警值")
    private String torqueAlarmValue;

    @ApiModelProperty(value = "吊重预警值")
    private String weightWarningValue;

    @ApiModelProperty(value = "吊重报警值")
