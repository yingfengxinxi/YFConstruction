...
@TableName("b_progress_self_evaluate_year")
@ApiModel(value="ProgressSelfEvaluateYear对象", description="年度自评")
public class ProgressSelfEvaluateYear implements Serializable {
