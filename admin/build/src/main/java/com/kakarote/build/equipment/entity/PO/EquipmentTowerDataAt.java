...
@TableName("b_equipment_tower_data_at")
@ApiModel(value="EquipmentTowerDataAt对象", description="塔机设备实时数据表")
public class EquipmentTowerDataAt implements Serializable {
    ...
    @ApiModelProperty(value = "防碰撞小车出预警 0:正常 1:报警 2:预警")
    private String collisionTrolleyAlarm;

    @ApiModelProperty(value = "防碰撞小车入预警 0:正常 1:报警 2:预警")
    ...
    private Float towerCollisionAlarm;
