...
@TableName("b_labour_attendance_detail")
@ApiModel(value="BLabourAttendanceDetail对象", description="考勤明细管理")
public class BLabourAttendanceDetail implements Serializable {
