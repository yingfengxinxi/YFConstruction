...
@ApiModel(value = "EquipmentFluoriteCloud对象", description = "萤石设备信息")
public class EquipmentFluoriteCloud implements Serializable {
    ...
    @ApiModelProperty(value = "IPC license")
    private String ipcLicense;

    @ApiModelProperty(value = "NVR license")
