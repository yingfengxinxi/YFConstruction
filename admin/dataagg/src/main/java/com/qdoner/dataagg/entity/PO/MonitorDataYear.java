...
@TableName("b_equipment_monitor_data_year")
@ApiModel(value="EquipmentMonitorDataYear对象", description="设备监测-监测项年数据表")
public class MonitorDataYear implements Serializable {
