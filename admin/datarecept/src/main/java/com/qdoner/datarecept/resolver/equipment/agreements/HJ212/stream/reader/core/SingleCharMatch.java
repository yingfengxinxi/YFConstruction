package com.qdoner.datarecept.resolver.equipment.agreements.HJ212.stream.reader.core;

import com.qdoner.datarecept.resolver.equipment.agreements.HJ212.stream.reader.base.MapEntryStepGenerator;
import com.qdoner.datarecept.resolver.equipment.agreements.HJ212.stream.reader.base.lambda.RunnableWithThrowable;
import com.qdoner.datarecept.resolver.equipment.agreements.HJ212.stream.reader.base.lambda.SupplierWithThrowable;
...
public class SingleCharMatch<ParentStream extends ReaderStream>
    ...
    public SingleCharMatch<ParentStream> then(RunnableWithThrowable<IOException> runnable) {
        generator.putValue(ReaderMatch.alwaysReturnPresent(runnable));
        return this;
    }

    public SingleCharMatch<ParentStream> skip() {
        generator.putValue(ReaderMatch.alwaysReturnPresent());
        return this;
    }
