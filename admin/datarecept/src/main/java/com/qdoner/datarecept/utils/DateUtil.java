...
public class DateUtil {
    ...
    public static String addDay(String date, int dayl) throws ParseException {
        return addOrSubtractDay(date, dayl, YMDHMS_);
    }
    /**
     * 日期增加天数
     *
     ...
     */
    public static String addOrSubtractDay(String date, int dayl, String formatStr) throws ParseException {
        SimpleDateFormat format = new SimpleDateFormat(formatStr);
        Date currdate = format.parse(date);
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(currdate);
        calendar.add(Calendar.DATE, dayl);
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(addDay("2023-03-20 00:00:00", -30));
    }
}