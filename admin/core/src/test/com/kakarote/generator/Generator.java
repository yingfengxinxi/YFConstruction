...
public class Generator {
    ...
    private static GlobalConfig getGlobalConfig(){
        ...
        globalConfig.setOutputDir("C:\\Work\\Code\\Build\\Code");
        globalConfig.setAuthor("pz");
    ...
    private static DataSourceConfig getDataSourceConfig(){
        ...
        dataSourceConfig.setUrl("jdbc:mysql://47.104.161.205:3306/wk_build?characterEncoding=utf8&useSSL=false&zeroDateTimeBehavior=convertToNull&tinyInt1isBit=false&serverTimezone=Asia/Shanghai");
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver");
        dataSourceConfig.setUsername("liangka");
        dataSourceConfig.setPassword("liangka");
    ...
    private static StrategyConfig getStrategyConfig(String modelName){
       ...
       strategyConfig.setLikeTable(new LikeTable("b_"+modelName, SqlLike.RIGHT));
        ...
        tableFillList.add(new TableFill("update_user_id", FieldFill.UPDATE));
    ...
    private static PackageConfig getPackageConfig(String modelName){
        ...
        packageConfig.setParent("com.kakarote.build.env");
