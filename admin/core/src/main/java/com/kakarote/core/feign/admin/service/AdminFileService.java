...
public interface AdminFileService {
    ...
    @RequestMapping(value = "/adminFile/queryFileListByBatchId/{batchId}", method = RequestMethod.POST)
    public Result<List<Map>> queryFileListByBatchId(@PathVariable("batchId") String batchId);
    ...
    @RequestMapping(value = "/adminFile/queryOneByBatchIdAndPath", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/adminFile/add", method = RequestMethod.POST)
