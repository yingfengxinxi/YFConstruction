...
public class AdminServiceImpl implements AdminService {
    ...
    @Override
    public Result<List<AdminConfig>> queryConfigByNameAndTenantId(String name) {
        return null;
    }

    @Override
    public Integer addDept(Map map) {
        return -1;
    }

    @Override
    public Integer addUser(Map user) {
        return -1;
    }

    @Override
    public Result addUser(AdminUserVO adminUserVO) {
        return null;
    }
    ...
    @Override
    public Result<Integer> queryDataTypeByRealm(Long userId, String realm) {
        return R.ok(1);
    }
    ...
    @Override
    public Result updateAdminConfigNoTenantId(AdminConfig adminConfig) {
        return R.ok();
    }
    ...
    @Override
    public Result<JSONObject> queryDeptConfigForMessage(String type, String messageType, Long tenantId) {
        return Result.ok(null);
    }

    @Override
    public Result<List<AdminDictData>> dictType(String dictType) {
        return Result.ok(new ArrayList<>());
    }
}
